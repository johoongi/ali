...
def seperate_product(driver):
    ...
    for ship_chk in all_shipping_charges[0:]:
        if 'AliExpress Standard Shipping' not in ship_chk.text or 'AliExpress Selection Shipping' not in ship_chk.text:
            
                if driver.find_elements(By.XPATH, r'//*[@class="comet-btn comet-btn-text _3djqy"]'):
                          #print('추가 클릭')
                          driver.find_element(By.XPATH, r'//*[@class="comet-btn comet-btn-text _3djqy"]').click()
                          sleep(0.5)
    ...
    for ship in all_shipping_charges[0:]:
        if 'AliExpress Standard Shipping' in ship.text or 'AliExpress Selection Shipping' in ship.text:
    ...
    option_top_code = '<div class="se-viewer se-theme-default" lang="ko-KR"><div class="se-component se-text se-l-default" id="SE-0796e3d9-00b5-47a3-bbf8-b32bcf946d54"><div class="se-component-content"><div class="se-section se-section-text se-l-default"><div class="se-module se-module-text"><!-- SE-TEXT { --><p class="se-text-paragraph se-text-paragraph-align-center " style="" id="SE-41e79b12-a5fb-4e49-9b6c-525ce21f9b34"><span style="" class="se-fs- se-ff-   " id="SE-316e23b7-5b2c-4a62-9749-e1861a5ab894"></span></p><!-- } SE-TEXT --><!-- SE-TEXT { --><p class="se-text-paragraph se-text-paragraph-align-center " style="" id="SE-2a7644d9-9cb0-4dcf-8ac6-b2d0089f4f83"><span style="" class="se-fs-fs30 se-ff-   " id="SE-a7e4c928-67a5-41e3-b5d6-2686442d0a09"><b>옵션 설명</b></span></p><!-- } SE-TEXT --><!-- SE-TEXT { --><p class="se-text-paragraph se-text-paragraph-align-center " style="" id="SE-0c2e5182-e11d-4e42-a041-c488f99ec359"><span style="" class="se-fs- se-ff-   " id="SE-526b1649-5224-4da4-bf6d-44131b2cc600"> </span></p><!-- } SE-TEXT --></div></div></div></div></div>'
    option_bottom_code = '<div class="se-viewer se-theme-default" lang="ko-KR"><div class="se-component se-horizontalLine se-l-default" id="SE-947f3b33-cd44-49b0-99a9-5c375a9770a3"><div class="se-component-content"><div class="se-section se-section-horizontalLine se-l-default se-section-align-center"><div class="se-module se-module-horizontalLine"><hr class="se-hr"></div></div></div></div><div class="se-component se-text se-l-default" id="SE-1f8b7851-9ad8-4cdd-9e57-dac0ce484fb4"><div class="se-component-content"><div class="se-section se-section-text se-l-default"><div class="se-module se-module-text"><!-- SE-TEXT { --><p class="se-text-paragraph se-text-paragraph-align-center " style="" id="SE-2e68f8cd-4233-4702-9689-46e1a82301b8"><span style="" class="se-fs-fs30 se-ff-   " id="SE-ca7a8937-3200-4f3d-89e8-d7eb6f81f6b0"><b>상세 페이지</b></span></p><!-- } SE-TEXT --><!-- SE-TEXT { --><p class="se-text-paragraph se-text-paragraph-align-center " style="" id="SE-2bfcf5ae-710a-4b53-8255-2c4cb53ab097"><span style="" class="se-fs- se-ff-   " id="SE-87258472-71dc-4537-beb2-0d09a1a78503"></span></p><!-- } SE-TEXT --><!-- SE-TEXT { --><p class="se-text-paragraph se-text-paragraph-align- " style="" id="SE-21887640-2ddd-45b6-8431-0e3413f38ae7"><span style="" class="se-fs- se-ff-   " id="SE-f714936e-6724-44e5-a06a-98215a05a066"></span></p><!-- } SE-TEXT --></div></div></div></div></div>'
    ...
    just_calculator = 1
    exel_data=[]
    img_src_all = '<center><div><img src="https://shop-phinf.pstatic.net/20221011_150/1665498732083sdHXH_JPEG/66634565892921623_1423703771.jpg?type=w860" data-src="https://shop-phinf.pstatic.net/20221011_150/1665498732083sdHXH_JPEG/66634565892921623_1423703771.jpg?type=w860" alt="" class="se-image-resource"></div><br>' + option_box_end
    ...
    for b in find_outline[0:]:
        ...
        if just_calculator == 5:
              ...
              for img_all_2 in img_all_1[0:]:
                if img_all_2.find_elements(By.CSS_SELECTOR, 'img') and not img_all_2.find_elements(By.CSS_SELECTOR, 'a'):
                    for img_src in img_all_2.find_elements(By.CSS_SELECTOR, 'img')[0:]:
                        img_src_all = img_src_all + '<div><img style="display:block;" src="'+ img_src.get_attribute('src') + '?type=w300" alt="" class="se-image-resource" width="860"></div>'      
    ...
    return title, first_price, option_image_name_all, price_all, major_img_src, view_img_all, img_src_all, now_url
